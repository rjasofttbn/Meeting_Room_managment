...
if (isset($_SESSION['user'])) {
  ...
  $result = $conn->prepare("SELECT `id`, `name`, `email`, `timestamp`,`status`, `role` FROM `mrbs_users` order by id desc");
  $result->execute();
}
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-2" style="text-align: center;">
                  <a class="btn btn-success" href="user_create.php" role="button"><i class="fa fa-plus-square"></i></a>
